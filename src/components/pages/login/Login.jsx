...
const Login = () => {
    ...
    return (
        <div className={`flex flex-col h-screen overflow-hidden ${slideUp ? 'bg-lightCoral' : 'bg-white'}`}>
          <div className={`flex flex-col ${slideUp ? 'h-0 opacity-0' : 'flex-grow'} transition-all duration-500 overflow-hidden`}>
